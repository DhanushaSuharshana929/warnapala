...
<html> 
    ...
    <body class="theme-red">
                            ...
                            <div class="body">
                                <form class="form-horizontal" method="post"  id="form-data" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">                                       
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="file"  class="form-control" value="<?php echo $OFFER->image_name; ?>"  name="image">
                                                <input type="hidden" id="image" class="form-control" value="<?php echo $OFFER->image_name; ?>"  name="image">
        ...
        <script src="js/ajax/offer.js" type="text/javascript"></script>
    </body>
