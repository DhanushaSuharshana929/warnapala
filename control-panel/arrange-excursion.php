            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Excursion Type photos</h2>
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/excursion-type.php" class="form-horizontal" >
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    <?php
                                                    $EXCURSION_TYPE_OBJ = new ExcursionType(NULL);
                                                    $EXCURSION_TYPE = $EXCURSION_TYPE_OBJ->all();
                                                    if (count($EXCURSION_TYPE) > 0) {
                                                        foreach ($EXCURSION_TYPE as $key => $img) {
                                                            ?>
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/excursion-type/thumb/<?php echo $img["image_name"]; ?>" alt=""/>
