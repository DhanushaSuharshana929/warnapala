                            ...
                            <div class="body">
                                ...
                                <div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        $EXCURSION_TYPE = ExcursionType::all();

                                        if (count($EXCURSION_TYPE) > 0) {

                                            foreach ($EXCURSION_TYPE as $key => $excursion_type) {

                                                ?>

                                                <div class="col-md-3"  id="div<?php echo $excursion_type['id']; ?>">

                                                    <div class="photo-img-container">

                                                        <img src="../upload/excursion-type/thumb/<?php echo $excursion_type['image_name']; ?>" class="img-responsive ">

                                                    </div>

                                                    <div class="img-caption">

                                                        <p class="maxlinetitle"><?php echo $excursion_type['name']; ?></p>
