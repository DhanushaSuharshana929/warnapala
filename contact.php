...
<html lang="en">
    ...
    <!-- Mirrored from designarc.biz/demos/wood-workshop/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Mar 2020 08:54:23 GMT -->
    <head>
        <meta charset="utf-8">
                            ...
                            <div class="row">   
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="txtFullName" name="yourname" placeholder="Full Name">
                                        <span id="spanFullName"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="txtEmail" name="yourno" placeholder="Contact No">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="txtPhone" name="youremail" placeholder="Email">
                                ...
                                <div class="row m0">
                                    <button type="submit" class="btn btn-default submit" id="btnSubmit">Submit Now</button>
                                </div></div>
    ...
    <!-- Mirrored from designarc.biz/demos/wood-workshop/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Mar 2020 08:54:29 GMT -->
</html>